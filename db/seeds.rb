...
Audited::Adapters::ActiveRecord::Audit.as_user(u0) do
  ...
  puts '   Added milestone ' + m.title
  m = project1.milestones.create(:title=>'Sprint 3 review', :start=>Date.tomorrow, :end=>Date.tomorrow, :class_name=>'bg-color-red txt-color-white', :icon=>'')
  puts '   Added milestone ' + m.title
  ...
  puts '   Added milestone ' + m.title
  m = project1.milestones.create(:title=>'Red?', :start=>Time.now.to_date, :end=>Time.now.to_date, :all_day=>true, :class_name=>'bg-color-red txt-color-white', :icon=>'')
  puts '   Added milestone ' + m.title
