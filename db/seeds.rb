...
Audited::Adapters::ActiveRecord::Audit.as_user(u0) do
  ...
  m = project1.milestones.create(:title=>'Sprint 1 complete', :start=>3.months.ago, :end=>3.months.ago, :class_name=>'bg-color-blue txt-color-white')
  puts '   Added milestone ' + m.title
  m = project1.milestones.create(:title=>'Sprint 2 complete', :start=>35.days.ago, :end=>35.days.ago, :class_name=>'bg-color-blue txt-color-white')
  puts '   Added milestone ' + m.title
  m = project1.milestones.create(:title=>'Sprint 3 complete', :start=>Date.tomorrow, :end=>Date.tomorrow, :class_name=>'bg-color-blue txt-color-white')
  puts '   Added milestone ' + m.title
  m = project1.milestones.create(:title=>'Sprint 3 review', :start=>Date.tomorrow, :end=>Date.tomorrow, :class_name=>'bg-color-red txt-color-white')
  puts '   Added milestone ' + m.title
  m = project1.milestones.create(:title=>'Signoff', :start=>Time.now.advance(:days=>7).to_date, :end=>Time.now.advance(:days=>7).to_date, :all_day=>true, :class_name=>'bg-color-blue txt-color-white')
  puts '   Added milestone ' + m.title
  m = project1.milestones.create(:title=>'Red?', :start=>Time.now.to_date, :end=>Time.now.to_date, :all_day=>true, :class_name=>'bg-color-red txt-color-white')
  puts '   Added milestone ' + m.title

  m = project5.milestones.create(:title=>'Initial Design', :start=>100.days.ago, :end=>98.days.ago, :class_name=>'bg-color-blue txt-color-white')
  puts '   Added milestone ' + m.title
