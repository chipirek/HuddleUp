...
class ActionItemsControllerTest < ActionController::TestCase
  ...
  test "should create action_item" do
    assert_difference('ActionItem.count') do
      post :create, action_item: { is_complete: @action_item.is_complete, issue_id: @action_item.issue_id, member_id: @action_item.member_id, subject: @action_item.subject }
    end
  ...
  test "should update action_item" do
    put :update, id: @action_item, action_item: { is_complete: @action_item.is_complete, issue_id: @action_item.issue_id, member_id: @action_item.member_id, subject: @action_item.subject }
    assert_redirected_to action_item_path(assigns(:action_item))
  end
